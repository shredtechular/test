...
class Editor_addon_parametric extends Editor_addon_generic {
	...
	private function getCustomFieldProperties( $field_slug = '' ) {
		...
		$field_properties = apply_filters( 'wpv_filter_wpv_paranetric_search_computed_field_properties', $field_properties );
		...
		if ( ! current_user_can( 'manage_options' ) ) {
			...
			if( $_POST['fields'] && sizeof( $_POST['fields']['url_param'] ) > 0 ) {
				...
				$settings['filter_controls_values']
						...
						= json_encode( array(
								'values'			=> $values,
								'auto_fill'			=> isset( $_POST['fields']['auto_fill'] ) ? $_POST['fields']['auto_fill'] : '',
								'auto_fill_default'	=> isset( $_POST['fields']['auto_fill_default'] ) ? $_POST['fields']['auto_fill_default'] : '',
								'auto_fill_sort'	=> isset( $_POST['fields']['auto_fill_sort'] ) ? $_POST['fields']['auto_fill_sort'] : '',
