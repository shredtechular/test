...
?>
<div id="sc_our_team" class="<?php echo $template == '' ? $this->options[ 'template' ] : $template; ?>">
    <?php
            ...
            <div itemscope itemtype="http://schema.org/Person" class="sc_team_member">
                <div class="sc_team_member_left">
                    ...
                    <a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"
                       class="<?php echo $this->check_clicker( $single_template ); ?>">
                    ...
                    <h3 itemprop="jobtitle" class="sc_team_member_jobtitle">
                ...
                <div class="sc_team_member_right">
                    ...
                    <div>
                        <?php echo wp_trim_words( get_post_field('post_content', get_the_ID() ), $this->options['word_count'] ); ?>
                    </div>                    
