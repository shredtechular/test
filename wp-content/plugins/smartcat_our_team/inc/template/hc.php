...
<div id="sc_our_team" class="<?php echo $template == '' ? $this->options[ 'template' ] : $template . ' sc-col' . $this->options[ 'columns' ]; ?> honeycombs">
    <?php
    if ( $members->have_posts() ) {
        while ( $members->have_posts() ) {
            $members->the_post();
            ?>
            <div itemscope itemtype="http://schema.org/Person" class="sc_team_member comb <?php echo $this->check_clicker( $single_template ); ?>">
