...
<div id="module-manager-wrap" class="wrap">
    ...
    if (( $toolset_any_embedded ) || ($toolset_all_disabled)) {
		...
		<div class="error">
			<p>
				<?php _e( 'Exporting and importing modules disabled. You will need to activate at least both full versions of Types and Views in order to enable this feature.', 'module-manager' ); ?>				
			</p>
		</div>		
