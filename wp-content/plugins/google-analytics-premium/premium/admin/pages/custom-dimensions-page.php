...
<div id="ga-promote">
	<p class="ga-topdescription">
		...
		printf(
			...
			"<a href='http://kb.yoast.com/article/179-how-do-i-setup-custom-dimensions/#utm_medium=helptext&utm_source=gawp-config&utm_campaign=wpgaplugin' target='_blank'>",
			"<a href='http://kb.yoast.com/article/178-where-can-i-find-the-custom-dimension-reports/#utm_medium=helptext&utm_source=gawp-config&utm_campaign=wpgaplugin' target='_blank'>",
			'</a>'
		);
		?>
		<br /><br />
